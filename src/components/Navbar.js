...
function Navbar()
{
  ...
  const toggleMode = () => {
    ...
    <Link className="navbar-brand" to="/" style={textCol}><img src={venky} alt="logo" style={{height:"50px",width:"60px"}}/></Link>
    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="toggle navigation">
      <span className="navbar-toggler-icon"></span>
    </button>
    <button className="btn btn-secondary d-lg-none ms-2">Mode</button>
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li className="nav-item">
       ...
       <li className="nav-item"><Link className="nav-link" to="/project"  style={textCol}>Projects</Link></li>
       <li className="nav-item"><Link className="nav-link" to="/contact"  style={textCol}>Contact Me</Link></li>
       <li className="nav-item"><Link className="nav-link" to="/resume" style={textCol}>Resume</Link></li>
      </ul>
